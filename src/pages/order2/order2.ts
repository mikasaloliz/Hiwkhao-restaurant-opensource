...
status:any;
  ...
  cancel(){
    ...
    loader.present().then(() => {
      this.http.post('api cancel order', data, options)
        .map(res => res.json())
        .subscribe(res => {
          loader.dismiss()
        });
  ...
  confirm()
  {
    ...
    loader.present().then(() => {
      this.http.post('api confirm order', data, options)
        .map(res => res.json())
        .subscribe(res => {
          loader.dismiss()
        });
  ...
  ionViewDidEnter(){
    ...
    loader.present().then(() => {
      this.http.post('htapi fetch order', data, options)
        .map(res => res.json())
        .subscribe(res => {
          ...
          this.http.post('api calculate price', data, options)
        .map(res => res.json())
        .subscribe(res => {
